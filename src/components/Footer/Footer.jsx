...
const Footer = () => {
    return (
        <div className="bg-[#0C1821] py-16 px-[60px]">
            ...
            <div className="grid grid-cols-8 gap-12">
                ...
                <div className='col-span-2'>
                    ...
                    <div className="mt-8 space-y-3">
                        ...
                        <div className="flex items-center gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#cbcbcb" fill="none" stroke="#cbcbcb" stroke-width="1.5" stroke-linecap="round">
