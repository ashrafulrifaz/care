    ...
    return (
        <div className='grid grid-cols-2 gap-10 p-5 h-screen'>
            <div className='relative w-full h-full rounded-3xl overflow-hidden'>
                <Image
                    src={'https://res.cloudinary.com/db30o33kz/image/upload/v1783874681/login_retkz1.jpg'}
                    alt='login image'
                    fill
            ...
            <div className='flex flex-col items-center justify-center w-full h-full overflow-y-auto'>
                ...
                <h3 className={`capitalize ${nunitoSans.className} mt-14 text-3xl font-bold`}>Welcome Back</h3>
                <p className='text-lg text-[#656565] mt-3'>Enter your details to log in to your account</p>
